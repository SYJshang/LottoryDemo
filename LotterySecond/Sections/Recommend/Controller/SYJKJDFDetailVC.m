...
@interface SYJKJDFDetailVC ()<UITableViewDelegate,UITableViewDataSource>{
...
@implementation SYJKJDFDetailVC
...
- (void)getHttpPic{
    ...
    [SYJHttpHelper GET:[NSString stringWithFormat:@"http://m.zhuoyicp.com/kaijang/dfRecents?getData=1&lotid=%@&page=%@&selnum=20",self.lotteryNo,page] parameters:nil success:^(id responseObject) {
