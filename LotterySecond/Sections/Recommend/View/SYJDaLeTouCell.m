...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.sixNum.backgroundColor = [UIColor blueColor];
        self.sixNum.font = [UIFont systemFontOfSize:10.0];
        self.sixNum.textAlignment = NSTextAlignmentCenter;
        self.sixNum.sd_layout.leftSpaceToView(self.fiveNum, 20).topSpaceToView(self.lotteryName, 10).heightIs(20).widthIs(20);
