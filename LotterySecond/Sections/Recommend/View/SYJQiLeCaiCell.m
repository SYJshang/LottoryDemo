...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.sevenNum.backgroundColor = [UIColor redColor];
        self.sevenNum.font = [UIFont systemFontOfSize:10.0];
        self.sevenNum.textAlignment = NSTextAlignmentCenter;
        self.sevenNum.sd_layout.leftSpaceToView(self.sixNum, 5).topSpaceToView(self.lotteryName, 10).heightIs(20).widthIs(20);
        ...
        self.eightNum = [[UILabel alloc]init];
        [self.contentView addSubview:self.eightNum];
        self.eightNum.textColor = [UIColor whiteColor];
        self.eightNum.backgroundColor = [UIColor blueColor];
        self.eightNum.font = [UIFont systemFontOfSize:10.0];
        self.eightNum.textAlignment = NSTextAlignmentCenter;
        self.eightNum.sd_layout.leftSpaceToView(self.sevenNum, 20).topSpaceToView(self.lotteryName, 10).heightIs(20).widthIs(20);
        self.eightNum.layer.masksToBounds = YES;
        self.eightNum.layer.cornerRadius = 10;
        self.eightNum.layer.borderColor = Gray.CGColor;
        self.eightNum.layer.borderWidth = 0.5;
